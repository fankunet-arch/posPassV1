...
CREATE TABLE `pass_redemptions` (
  ...
  `member_pass_id` int UNSIGNED NOT NULL COMMENT 'FK, 关联 member_passes.member_pass_id',
  `order_id` int UNSIGNED NOT NULL COMMENT 'FK, 关联 pos_invoices.id (TP税票ID)',
  `order_item_id` int UNSIGNED NOT NULL COMMENT 'FK, 关联 pos_invoice_items.id (对应单品)',
